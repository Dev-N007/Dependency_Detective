        ...
        <div>
          ...
          <div className="p-6 border-b border-slate-200 dark:border-[#202b3c] flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-sky-100 dark:bg-cyan-950 border border-sky-300 dark:border-cyan-500/30 flex items-center justify-center text-sky-600 dark:text-cyan-400">
                <FileCode className="w-4 h-4" />
              </div>
              <div>
                <span className="text-[10px] font-mono uppercase text-sky-600 dark:text-cyan-400 block tracking-widest font-bold">
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center gap-3 text-xs font-mono">
              <span className="px-2.5 py-1 rounded bg-sky-100 dark:bg-cyan-950 border border-sky-300 dark:border-cyan-500/30 text-sky-700 dark:text-cyan-400 font-bold flex items-center gap-1.5">
                <Tag className="w-3.5 h-3.5" /> Line {evidence.line_number}
              </span>
              <span className="px-2.5 py-1 rounded bg-slate-100 dark:bg-[#151b26] border border-slate-200 dark:border-[#202b3c] text-slate-700 dark:text-slate-300">
                Type: {evidence.evidence_type}
              </span>
            </div>

            <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#151b26] border border-slate-200 dark:border-[#202b3c]">
              <span className="text-xs font-mono text-slate-500 dark:text-slate-400 block mb-1">Description</span>
              <p className="text-xs font-mono text-slate-800 dark:text-slate-200">{evidence.description}</p>
            </div>

            {/* Code Snippet Box */}
            <div className="space-y-2">
              <span className="text-xs font-mono text-slate-500 dark:text-slate-400 block font-bold">Source Code Snippet Context</span>
