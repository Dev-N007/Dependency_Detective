...
export const StatsBar: React.FC<StatsBarProps> = ({ stats }) => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 p-4 bg-slate-100/90 dark:bg-[#0f141d]/80 border-b border-slate-200 dark:border-[#202b3c] transition-colors">
      <div className="p-3 rounded-xl bg-white dark:bg-[#151b26] border border-slate-200 dark:border-[#202b3c] flex flex-col justify-between shadow-xs">
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs font-mono">
          ...
          <Package className="w-4 h-4 text-sky-500 dark:text-cyan-400" />
        </div>
      ...
      <div className="p-3 rounded-xl bg-white dark:bg-[#151b26] border border-slate-200 dark:border-[#202b3c] flex flex-col justify-between shadow-xs">
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs font-mono">
          <span>Removable</span>
          <Trash2 className="w-4 h-4 text-indigo-600 dark:text-purple-400" />
        </div>
        <div className="mt-2 text-xl font-bold font-mono text-indigo-600 dark:text-purple-400">
