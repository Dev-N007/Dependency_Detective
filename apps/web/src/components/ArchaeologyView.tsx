    ...
    <div className="flex-1 bg-slate-50 dark:bg-[#080a0f] overflow-y-auto p-6 space-y-6 transition-colors">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xs font-mono px-2.5 py-0.5 rounded-full bg-purple-50 dark:bg-purple-950 text-purple-700 dark:text-purple-400 border border-purple-200 dark:border-purple-500/30 uppercase tracking-wider font-semibold">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-white dark:bg-[#151b26] border border-slate-200 dark:border-[#202b3c] hover:border-slate-300 dark:hover:border-slate-500 text-xs font-mono text-slate-700 dark:text-slate-300 transition-colors flex items-center gap-2 self-start md:self-auto cursor-pointer shadow-xs font-semibold"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-4 rounded-xl bg-white dark:bg-[#0f141d] border border-slate-200 dark:border-[#202b3c] shadow-xs">
          ...
          <span className="text-lg font-bold font-mono text-purple-700 dark:text-purple-400 flex items-center gap-1.5">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-[#0f141d] border border-slate-200 dark:border-[#202b3c] shadow-xs">
          ...
          <span className="text-lg font-bold font-mono text-sky-700 dark:text-cyan-300 flex items-center gap-1.5">
      ...
      <div className="space-y-4">
        ...
        <div className="relative pl-6 space-y-6 before:absolute before:left-2.5 before:top-3 before:bottom-3 before:w-0.5 before:bg-slate-200 dark:before:bg-[#202b3c]">
          {report.timeline.map((event, idx) => (
            <div key={idx} className="relative pl-6">
              <div
                className={`absolute -left-6 top-1.5 w-5 h-5 rounded-full border flex items-center justify-center text-[10px] font-mono font-bold ${
                  event.event_type === 'introduced'
                    ? 'bg-purple-50 dark:bg-purple-950 border-purple-400 text-purple-700 dark:text-purple-400 glow-purple'
                    : event.event_type === 'current'
                    ? 'bg-sky-50 dark:bg-cyan-950 border-sky-400 dark:border-cyan-500 text-sky-700 dark:text-cyan-400 glow-cyan'
              ...
              <div className="p-4 rounded-xl bg-white dark:bg-[#0f141d] border border-slate-200 dark:border-[#202b3c] space-y-2 shadow-xs">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 font-mono text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <span className="px-2 py-0.5 rounded bg-slate-100 dark:bg-[#151b26] border border-slate-200 dark:border-[#202b3c] text-sky-700 dark:text-cyan-400 font-bold">
                      {event.commit_hash}
                    </span>
                  </div>
                </div>
